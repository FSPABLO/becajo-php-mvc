...
-- Migración 07 — Fase C: PKG_INDICADORES v2
-- Preparado por Persona 2
--
-- Reemplaza el paquete completo (así funciona Oracle: no hay "ALTER PACKAGE
-- ADD procedimiento"). Cambios respecto a la versión anterior:
--
